...
<t:template pageTitle="Muokkaa laskuttajan tiedotoja" selectedTab="1">
    <c:forEach items="${errors}" var="error">
        ${error.key}: ${error.value} <br>
    </c:forEach>
    <div class="container">
        <form class="form-horizontal" role="form" action="LaskuttajaServletUpdate" method="POST">
