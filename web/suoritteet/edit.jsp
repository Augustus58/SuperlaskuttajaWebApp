...
<t:template pageTitle="Muokkaa suoritetta" selectedTab="3">
    <c:forEach items="${errors}" var="error">
        ${error.key}: ${error.value} <br>
    </c:forEach>
    <div class="container">
        <form class="form-horizontal" role="form" action="SuoriteServletUpdate" method="POST">
